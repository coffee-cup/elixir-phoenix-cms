defmodule WritingWeb.UserControllerTest do
  use WritingWeb.ConnCase

  alias Writing.Accounts

  @create_attrs %{auth_provider: "some auth_provider", email: "some email", first_name: "some first_name", last_name: "some last_name"}
